...
| 单词 | 常见义 | 考研僻义 | 预警级别 | 考频 |
|------|--------|----------|----------|------|
| **compound** | 复合的；化合物 | vt. 加剧，恶化 | 🔴 Critical | 60% |
| **collaborate** | 合作 | 通敌 | 🟡 Warning | 30% |
| **diplomatic** | 外交的 | 圆滑的 | 🟡 Warning | 25% |
...
| conceal | hide, cover up | reveal, expose |
| compulsory | mandatory, obligatory | optional, voluntary |
| coherent | logical, consistent | incoherent, disjointed |
| enthusiastic | passionate, eager | indifferent, apathetic |
| bizarre | strange, odd | normal, ordinary |
| wholesome | healthy, beneficial | harmful, unhealthy |
...
| 词根 | 含义 | 包含单词 |
|------|------|----------|
| **com-** | 共同，一起 | company, companion, compound, compatible, compassion, coherent, cohesive, collaborate |
| **di-** | 分开，通过 | direction, director, directory, diploma, diplomatic, dimension, dioxide, dinosaur |
| **en-** | 使...，进入 | enthusiasm, enthusiastic, entry, entrance, entity, entitle, entire |
| **wh-** | 疑问/关系 | whoever, whichever, wherever, whereby, whereas, whenever, whatever, while |
...
## 📈 学习建议
1. **重点记忆僻义词**: compound (加剧), collaborate (通敌), diplomatic (圆滑的)
2. **词族联想法**: 按词根分组记忆，提高效率
3. **写作应用**: 将 address, equip, collaborate, coherent 用于写作练习
4. **语境巩固**: 阅读真题语境文章加深理解
