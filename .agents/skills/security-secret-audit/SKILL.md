...
.agents/skills/security-secret-audit/scripts/audit-secrets.sh

# Only the staged content; use immediately before committing.
.agents/skills/security-secret-audit/scripts/audit-secrets.sh --staged

# Every unique file version reachable from Git history; use after a suspected past leak.
.agents/skills/security-secret-audit/scripts/audit-secrets.sh --history
```
